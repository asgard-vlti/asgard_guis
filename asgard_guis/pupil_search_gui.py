...
from asgard_guis.spiral_search import PupilSearchIntegrator
...
def main():
    parser = argparse.ArgumentParser(description="Pupil Search GUI")
    parser.add_argument(
        "--debug",
        action="store_true",
    ...
    win = PupilSearchGUI(debug=args.debug)
    win.show()
    sys.exit(app.exec_())
